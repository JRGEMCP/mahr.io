...
@Component({
  selector: 'm8io-course-form-preview',
  templateUrl: './course-form-preview.component.html',
  styleUrls: ['./course-form-preview.component.scss']
})
export class CourseFormPreviewComponent implements OnInit {
  @Input() course;
  @Input() livePreview;
  @Input() user;
